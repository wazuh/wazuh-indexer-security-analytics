...
public class WTransportIndexWazuhIntegrationAction extends HandledTransportAction<WIndexIntegrationRequest, WIndexIntegrationResponse> implements SecureTransportAction {
    private static final Logger log = LogManager.getLogger(WTransportIndexWazuhIntegrationAction.class);
    private final Client client;

    @Inject
    public WTransportIndexWazuhIntegrationAction(TransportService transportService,
                                                 Client client,
