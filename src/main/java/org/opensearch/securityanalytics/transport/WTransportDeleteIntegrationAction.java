...
public class WTransportDeleteIntegrationAction extends HandledTransportAction<WDeleteIntegrationRequest, WDeleteIntegrationResponse>
    ...
    private void resolveAndDelete(WDeleteIntegrationRequest request, ActionListener<WDeleteIntegrationResponse> listener) {
        ...
        SearchRequest searchRequest = new SearchRequest(LogTypeService.LOG_TYPE_INDEX).source(searchSource);
        ...
        this.client.search(searchRequest, new ActionListener<>() {
            ...
            public void onResponse(SearchResponse searchResponse) {
                ...
                WTransportDeleteIntegrationAction.this.deleteById(resolvedId, request.getRefreshPolicy(), listener);
            }
    ...
    private void deleteById(
        ...
        DeleteCustomLogTypeRequest internalRequest = new DeleteCustomLogTypeRequest(logTypeId, refreshPolicy);
