...
public class AggregationBackendTests extends OpenSearchTestCase {
    ...
    private static final Map<String, String> windowsFieldMappings =
            Map.of(
                    "EventID", "event_uid",
    ...
    public void testCountAggregation() throws SigmaError, IOException, CompositeSigmaErrors {
        OSQueryBackend queryBackend = new OSQueryBackend(windowsFieldMappings, true);
        List<Object> queries =
        ...
        Assert.assertEquals(
                "(fieldA: \"valueA\") AND (mappedB: \"valueB\") AND (fieldC: \"valueC\")", query);

        OSQueryBackend.AggregationQueries aggQueries =
                (OSQueryBackend.AggregationQueries) queries.get(1);
        ...
        Assert.assertEquals(
                "{\"buckets_path\":{\"_cnt\":\"_count\"},\"parent_bucket_path\":\"result_agg\",\"script\":{\"source\":\"params._cnt > 1.0\",\"lang\":\"painless\"}}",
                bucketTriggerQuery);
    }

    public void testCountAggregationWithGroupBy()
            throws IOException, CompositeSigmaErrors, SigmaError {
        OSQueryBackend queryBackend = new OSQueryBackend(windowsFieldMappings, true);
        List<Object> queries =
                queryBackend.convertRule(
                        SigmaRule.fromYaml(
                                "            title: Test\n"
                                        ...
                                        + "                    fieldB: valueB\n"
                                        + "                    fieldC: valueC\n"
                                        + "                condition: sel | count(*) by fieldB > 1",
                                true));
    ...
    public void testSumAggregationWithGroupBy() throws IOException, CompositeSigmaErrors, SigmaError {
        ...
        Assert.assertEquals(
                "{\"result_agg\":{\"terms\":{\"field\":\"mappedB\"},\"aggs\":{\"fieldA\":{\"sum\":{\"field\":\"fieldA\"}}}}}",
                aggQuery);
        // triggers.bucket_level_trigger.condition -> Condition
        Assert.assertEquals(
                "{\"buckets_path\":{\"fieldA\":\"fieldA\"},\"parent_bucket_path\":\"result_agg\",\"script\":{\"source\":\"params.fieldA > 110.0\",\"lang\":\"painless\"}}",
                bucketTriggerQuery);
    }
    ...
    public void testMinAggregationWithGroupBy() throws IOException, CompositeSigmaErrors, SigmaError {
                ...
                queryBackend.convertRule(
                        SigmaRule.fromYaml(
                                "            title: Test\n"
                                        ...
                                        + "                    fieldB: valueB\n"
                                        + "                    fieldC: valueC\n"
                                        + "                condition: sel | min(fieldA) by fieldB > 110",
                                true));
        ...
        Assert.assertEquals(
                "{\"result_agg\":{\"terms\":{\"field\":\"mappedB\"},\"aggs\":{\"fieldA\":{\"min\":{\"field\":\"fieldA\"}}}}}",
                aggQuery);
        Assert.assertEquals(
                "{\"buckets_path\":{\"fieldA\":\"fieldA\"},\"parent_bucket_path\":\"result_agg\",\"script\":{\"source\":\"params.fieldA > 110.0\",\"lang\":\"painless\"}}",
                bucketTriggerQuery);
    ...
    public void testMaxAggregationWithGroupBy() throws IOException, CompositeSigmaErrors, SigmaError {
        ...
        Assert.assertEquals(
                "{\"result_agg\":{\"terms\":{\"field\":\"mappedB\"},\"aggs\":{\"fieldA\":{\"max\":{\"field\":\"fieldA\"}}}}}",
                aggQuery);
        Assert.assertEquals(
                "{\"buckets_path\":{\"fieldA\":\"fieldA\"},\"parent_bucket_path\":\"result_agg\",\"script\":{\"source\":\"params.fieldA > 110.0\",\"lang\":\"painless\"}}",
                bucketTriggerQuery);
    ...
    public void testAvgAggregationWithGroupBy() throws IOException, CompositeSigmaErrors, SigmaError {
        ...
        Assert.assertEquals(
                "{\"result_agg\":{\"terms\":{\"field\":\"mappedB\"},\"aggs\":{\"fieldA\":{\"avg\":{\"field\":\"fieldA\"}}}}}",
                aggQuery);
        Assert.assertEquals(
                "{\"buckets_path\":{\"fieldA\":\"fieldA\"},\"parent_bucket_path\":\"result_agg\",\"script\":{\"source\":\"params.fieldA > 110.0\",\"lang\":\"painless\"}}",
                bucketTriggerQuery);
    ...
    public void testCloudtrailAggregationRule() throws IOException, CompositeSigmaErrors, SigmaError {
        OSQueryBackend queryBackend = new OSQueryBackend(Map.of(), true);
        List<Object> queries =
                queryBackend.convertRule(
                        SigmaRule.fromYaml(
                                "id: c64c5175-5189-431b-a55e-6d9882158250\n"
                                        ...
                                        + "      - DELETED\n"
                                        + "  timeframe: 24h\n"
                                        + "  condition: selection | count(*) by accountid > 2",
                                true));
        ...
        Assert.assertEquals(
                "{\"buckets_path\":{\"_cnt\":\"_count\"},\"parent_bucket_path\":\"result_agg\",\"script\":{\"source\":\"params._cnt > 2.0\",\"lang\":\"painless\"}}",
                bucketTriggerQuery);
    }

    public void testCloudtrailAggregationRuleWithDotFields()
            throws IOException, CompositeSigmaErrors, SigmaError {
        OSQueryBackend queryBackend = new OSQueryBackend(Map.of(), true);
        List<Object> queries =
                queryBackend.convertRule(
        ...
        String query = queries.get(0).toString();
        Assert.assertEquals(
                "((api.service.name: \"lambda.amazonaws.com\") AND (api.operation: \"CreateFunction\")) OR ((api.service.name: \"lambda.amazonaws.com\") AND (api.operation: \"Invoke\"))",
                query);
        ...
        Assert.assertEquals(
                "{\"result_agg\":{\"terms\":{\"field\":\"cloud.region\"},\"aggs\":{\"api_operation\":{\"value_count\":{\"field\":\"api.operation\"}}}}}",
                aggQuery);
        Assert.assertEquals(
                "{\"buckets_path\":{\"api_operation\":\"api.operation\"},\"parent_bucket_path\":\"result_agg\",\"script\":{\"source\":\"params.api_operation > 1.0\",\"lang\":\"painless\"}}",
                bucketTriggerQuery);
    }
}
