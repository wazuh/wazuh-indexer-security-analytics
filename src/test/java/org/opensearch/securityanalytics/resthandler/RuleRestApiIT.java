...
public class RuleRestApiIT extends SecurityAnalyticsRestTestCase {
    ...
    public void testCreatingARule() throws IOException {
        ...
        Assert.assertEquals(
                ...
                String.format(
                        Locale.getDefault(), "%s/%s", SecurityAnalyticsPlugin.RULE_BASE_URI, createdId),
    ...
    public void testCreatingARule_custom_category() throws IOException {
        ...
        try {
            makeRequest(
                    ...
                    "POST",
                    SecurityAnalyticsPlugin.RULE_BASE_URI,
                    Collections.singletonMap("category", "unknown_category"),
                    new StringEntity(rule),
                    new BasicHeader("Content-Type", "application/json"));
            fail("expected exception due to invalid category");
        } catch (ResponseException e) {
            assertEquals(HttpStatus.SC_BAD_REQUEST, e.getResponse().getStatusLine().getStatusCode());
            Assert.assertTrue(e.getMessage().contains("Invalid rule category"));
        }
    }
    ...
    public void testCreatingAggregationRule() throws SigmaError, IOException {
        Response createResponse =
                makeRequest(
                        ...
                        "POST",
                        SecurityAnalyticsPlugin.RULE_BASE_URI,
                        Collections.singletonMap("category", "windows"),
                        new StringEntity(countAggregationTestRule()),
                        new BasicHeader("Content-Type", "application/json"));
        Assert.assertEquals("Create rule failed", RestStatus.CREATED, restStatus(createResponse));
        ...
        XContentParser xcp =
                XContentType.JSON
                        ...
                        .createParser(
                                ...
                                hits.get(0).getSourceAsString());
        Rule result = Rule.docParse(xcp, null, null);

        Assert.assertEquals(1, result.getAggregationQueries().size());
        String expected =
                "{\"aggQuery\":\"{\\\"result_agg\\\":{\\\"terms\\\":{\\\"field\\\":\\\"_index\\\"}}}\",\"bucketTriggerQuery\":\"{\\\"buckets_path\\\":{\\\"_cnt\\\":\\\"_count\\\"},\\\"parent_bucket_path\\\":\\\"result_agg\\\",\\\"script\\\":{\\\"source\\\":\\\"params._cnt > 1.0\\\",\\\"lang\\\":\\\"painless\\\"}}\"}";
    ...
    public void testSearchingPrepackagedRules() throws IOException {
        ...
        Assert.assertEquals(
                5,
                ((Map<String, Object>) ((Map<String, Object>) responseBody.get("hits")).get("total"))
                        .get("value"));
    }
    ...
    public void testSearchingForDuplicatedPrepackagedRules() throws IOException {
        ...
        Response gworkSpaceSearchResponse =
                makeRequest(
                        client(),
                        "POST",
                        String.format(Locale.getDefault(), "%s/_search", SecurityAnalyticsPlugin.RULE_BASE_URI),
                        Collections.singletonMap("pre_packaged", "true"),
                        new StringEntity(gworkspaceRequest),
                        new BasicHeader("Content-Type", "application/json"));
        Assert.assertEquals(
                "Searching rules failed", RestStatus.OK, restStatus(gworkSpaceSearchResponse));
        ...
        Response azureSearchResponse =
                makeRequest(
                        client(),
                        "POST",
                        String.format(Locale.getDefault(), "%s/_search", SecurityAnalyticsPlugin.RULE_BASE_URI),
                        Collections.singletonMap("pre_packaged", "true"),
                        new StringEntity(azureRequest),
                        new BasicHeader("Content-Type", "application/json"));
        ...
        Assert.assertEquals(
                7,
                ((Map<String, Object>)
                                ((Map<String, Object>) gworkspaceResponseBody.get("hits")).get("total"))
                        .get("value"));
        Map<String, Object> azureResponseBody = asMap(azureSearchResponse);
        Assert.assertEquals(
                127,
                ((Map<String, Object>) ((Map<String, Object>) azureResponseBody.get("hits")).get("total"))
                        .get("value"));
    }
    ...
    public void testSearchingPrepackagedRulesByPages() throws IOException {
        ...
        Assert.assertEquals(
                20,
                ((List<SearchHit>) ((Map<String, Object>) responseBody.get("hits")).get("hits")).size());
    }
    ...
    public void testSearchingCustomRulesWhenNoneExist() throws IOException {
        ...
        Response searchResponse =
                makeRequest(
                        ...
                        "POST",
                        String.format(Locale.getDefault(), "%s/_search", SecurityAnalyticsPlugin.RULE_BASE_URI),
                        Collections.singletonMap("pre_packaged", "false"),
                        new StringEntity(request),
                        new BasicHeader("Content-Type", "application/json"));
        Assert.assertEquals("Searching rules failed", RestStatus.OK, restStatus(searchResponse));
        Map<String, Object> responseBody = asMap(searchResponse);
    ...
    public void testUpdatingUnusedRule() throws IOException {
        ...
        Response updateResponse =
                makeRequest(
                        client(),
                        "PUT",
                        SecurityAnalyticsPlugin.RULE_BASE_URI + "/" + createdId,
                        Map.of("category", randomDetectorType()),
                        new StringEntity(randomEditedRule()),
                        new BasicHeader("Content-Type", "application/json"));
    ...
    public void testUpdatingARule_custom_category() throws IOException {
        ...
        try {
            makeRequest(
                    ...
                    "PUT",
                    SecurityAnalyticsPlugin.RULE_BASE_URI + "/" + createdId,
                    Map.of("category", "unknown_category"),
                    new StringEntity(randomEditedRule()),
                    new BasicHeader("Content-Type", "application/json"));
            fail("expected exception due to invalid category");
        } catch (ResponseException e) {
    ...
    public void testUpdatingUsedRule() throws IOException {
        ...
        try {
            ...
            Assert.assertTrue(
                    new String(ex.getResponse().getEntity().getContent().readAllBytes())
                            .contains(
                                    String.format(
                                            Locale.getDefault(),
        ...
        Response updateResponse =
                makeRequest(
                        ...
                        "PUT",
                        SecurityAnalyticsPlugin.RULE_BASE_URI + "/" + createdId,
                        Map.of("category", randomDetectorType(), "forced", "true"),
                        new StringEntity(randomEditedRule()),
                        new BasicHeader("Content-Type", "application/json"));
        Assert.assertEquals("Update rule failed", RestStatus.OK, restStatus(updateResponse));
    ...
    public void testDeletingUsedRule() throws IOException {
        ...
        String request =
                "{\n"
                        ...
                        + "}";
        List<SearchHit> hits =
                executeSearch(DetectorMonitorConfig.getRuleIndex(randomDetectorType()) + "*", request);
        ...
        Response deleteResponse =
                makeRequest(
                        ...
                        "DELETE",
                        SecurityAnalyticsPlugin.RULE_BASE_URI + "/" + createdId,
                        Collections.singletonMap("forced", "true"),
                        null);
        Assert.assertEquals("Delete rule failed", RestStatus.OK, restStatus(deleteResponse));
    ...
    public void testDeletingNonExistingCustomRule() throws IOException {
        try {
            makeRequest(
                    client(),
                    "DELETE",
                    SecurityAnalyticsPlugin.RULE_BASE_URI + "/" + java.util.UUID.randomUUID(),
                    Collections.emptyMap(),
                    null);
        } catch (ResponseException ex) {
    ...
    public void testCustomRuleValidation() throws IOException {
        ...
        Assert.assertEquals(
                "Incorrect Location header",
                String.format(
                        Locale.getDefault(), "%s/%s", SecurityAnalyticsPlugin.RULE_BASE_URI, rule1createdId),
                createResponse.getHeader("Location"));
        // Create rule #2
        createResponse =
                makeRequest(
        ...
        Assert.assertEquals(
                "Incorrect Location header",
                String.format(
                        Locale.getDefault(), "%s/%s", SecurityAnalyticsPlugin.RULE_BASE_URI, rule2createdId),
                createResponse.getHeader("Location"));
        ...
        Response validationResponse =
                makeRequest(
                        client(),
                        "POST",
                        SecurityAnalyticsPlugin.RULE_BASE_URI + "/validate",
                        Collections.EMPTY_MAP,
                        new StringEntity(validateRulesRequest),
                        new BasicHeader("Content-Type", "application/json"));
    ...
    public void testGetAllRuleCategories() throws IOException {
        Response response =
                makeRequest(
                        client(),
                        "GET",
                        SecurityAnalyticsPlugin.RULE_BASE_URI + "/categories",
                        Collections.emptyMap(),
                        null);
        List<Object> categories = (List<Object>) asMap(response).get("rule_categories");
        assertEquals(23, categories.size());
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("ad_ldap")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("dns")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("network")));
        assertTrue(
                categories.stream()
                        .anyMatch(e -> ((Map<String, Object>) e).get("key").equals("cloudtrail")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("s3")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("windows")));
        assertTrue(
                categories.stream()
                        .anyMatch(e -> ((Map<String, Object>) e).get("key").equals("gworkspace")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("github")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("m365")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("okta")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("azure")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("linux")));
        assertTrue(
                categories.stream().anyMatch(e -> ((Map<String, Object>) e).get("key").equals("waf")));
    }
    ...
    public void testGetMappingsViewApiForFieldAliasesWithSameName() throws IOException {
        ...
        respMap = responseAsMap(response);
        Assert.assertTrue(
                ((List<String>) respMap.get("unmapped_field_aliases")).contains("Access_List"));
        Assert.assertTrue(((Map<String, Object>) respMap.get("properties")).containsKey("AccessList"));
    }
}
