...
public class CustomLogTypeRestApiIT extends SecurityAnalyticsRestTestCase {
    ...
    public void testEditACustomLogTypeDescription() throws IOException {
        ...
        int correlationId =
                Integer.parseInt(
                        ((Map<String, Object>)
                                        (((Map<String, Object>) responseBody.get("logType")).get("tags")))
                                .get("correlation_id")
                                .toString());
        Assert.assertEquals(
                customLogType.getDescription(),
        ...
        Response updatedResponse =
                makeRequest(
                        client(),
                        "PUT",
                        SecurityAnalyticsPlugin.CUSTOM_LOG_TYPE_URI + "/" + logTypeId,
                        Collections.emptyMap(),
                        toHttpEntity(customLogType));
        Assert.assertEquals(
                "Create custom log type failed", RestStatus.OK, restStatus(updatedResponse));
        ...
        int correlationId =
                Integer.parseInt(
                        ((Map<String, Object>)
                                ...
                                .toString());
        Assert.assertEquals(
                customLogType.getCategory(),
                ((Map<String, Object>) responseBody.get("logType")).get("category"));
    ...
    public void testEditACustomLogTypeWithoutDetectors() throws IOException {
        ...
        Response updatedResponse =
                makeRequest(
                        ...
                        SecurityAnalyticsPlugin.CUSTOM_LOG_TYPE_URI + "/" + logTypeId,
                        Collections.emptyMap(),
                        toHttpEntity(updatedCustomLogType));
        Assert.assertEquals(
                "Update custom log type failed", RestStatus.OK, restStatus(updatedResponse));

        responseBody = asMap(updatedResponse);
        Assert.assertEquals(
                updatedCustomLogType.getDescription(),
                ((Map<String, Object>) responseBody.get("logType")).get("description"));
    }
    ...
    public void testEditACustomLogTypeNameWhenCustomRuleIndexMissing() throws IOException {
        ...
        createResponse =
                makeRequest(
                        ...
                        toHttpEntity(detector));
        Assert.assertEquals(
                "Create detector successful", RestStatus.CREATED, restStatus(createResponse));
        ...
        Response updatedResponse =
                makeRequest(
                        ...
                        toHttpEntity(customLogType));
        Assert.assertEquals(
                "Update custom log type successful", RestStatus.OK, restStatus(updatedResponse));
    ...
    public void testEditACustomLogTypeName() throws IOException, InterruptedException {
        ...
        deleteResponse =
                makeRequest(
                        client(),
                        "DELETE",
                        SecurityAnalyticsPlugin.RULE_BASE_URI + "/" + ruleId,
                        Collections.emptyMap(),
                        null);
        ...
        responseBody = asMap(updatedResponse);
        Assert.assertEquals(
                updatedCustomLogType.getName(),
                ((Map<String, Object>) responseBody.get("logType")).get("name"));
    }
    ...
    public void testSearchLogTypes() throws IOException, InterruptedException {
        ...
        Response searchResponse =
                makeRequest(
                        ...
                        "POST",
                        String.format(
                                Locale.getDefault(), "%s/_search", SecurityAnalyticsPlugin.CUSTOM_LOG_TYPE_URI),
                        Collections.emptyMap(),
    ...
    public void testDeleteCustomLogTypeWithDetectorIndexMissing() throws IOException {
        ...
        Response createResponse =
                makeRequest(
                        ...
                        toHttpEntity(customLogType));
        Assert.assertEquals(
                "Create custom log type successful", RestStatus.CREATED, restStatus(createResponse));
        ...
        deleteResponse =
                makeRequest(
                        ...
                        new StringEntity(""));
        Assert.assertEquals(
                "Delete custom log type successful", RestStatus.OK, restStatus(deleteResponse));
    }
