...
public class WIndexRuleRequestImpl extends ActionRequest implements WIndexRuleRequest {
    ...
    public WIndexRuleRequestImpl(StreamInput sin) throws IOException {
        this(sin.readString(),
